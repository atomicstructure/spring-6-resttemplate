...
public class BeerClientMockTest {
    ...
    void testListBeersWithQueryParam() throws JsonProcessingException {
        ...
        URI uri = UriComponentsBuilder.fromHttpUrl(URL + BeerClientImpl.BEERS_URL)
    ...
    void testDeleteNotFound() {
        server.expect(method(HttpMethod.DELETE))
                .andExpect(requestToUriTemplate(URL + BeerClientImpl.BEER_ID_URL,
                        dto.getId()))
    ...
    void testUpdateBeer() {
        ...
        BeerDTO responseDto = beerClient.updateByID(dto);
        assertThat(responseDto.getId()).isEqualTo(dto.getId());
    }

    @Test
    void testCreateBeer()  {
        URI uri = UriComponentsBuilder.fromPath(BeerClientImpl.BEER_ID_URL)
                .build(dto.getId());
